...
/**
 * Created by etenel on 2017/7/14.
 */
    ...
    public class Line {
        ...
        public void layout(int t, int l) {
            ...
            for (View view : views) {
                ...
                // 重新测量
                view.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth + avg, View.MeasureSpec.UNSPECIFIED),
                        View.MeasureSpec.makeMeasureSpec(measuredHeight, View.MeasureSpec.UNSPECIFIED));
                // 重新获取宽度值
