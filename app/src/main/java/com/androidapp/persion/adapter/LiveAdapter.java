...
import com.androidapp.activity.LivePlayerActivity;
...
public class LiveAdapter extends RecyclerView.Adapter {
    ...
    private LiveBean mLiveAppIndexInfo;
    ...
    public LiveAdapter(Context context, List<String> images) {
    ...
    public void setLiveInfo(LiveBean liveAppIndexInfo) {
        ...
        List<LiveBean.DataBean.BannerBean> banner = mLiveAppIndexInfo.getData().getBanner();
...
//                        bannerBean.getLink(), bannerBean.getTitle(), bannerBean.getImg())));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_LIVE_ITEM:
                view = LayoutInflater.from(viewGroup.getContext())
                        .inflate(R.layout.item_live_content, null);
                return new LiveItemViewHolder(view);
            case TYPE_PARTITION:
                view = LayoutInflater.from(viewGroup.getContext())
                        .inflate(R.layout.item_live_title, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        position -= 1;
        final LiveBean.DataBean.PartitionsBean.LivesBean livesBean;
        if (holder instanceof LiveEntranceViewHolder) {
            ...
            liveItemViewHolder.itemLiveLayout.setOnClickListener(v -> LivePlayerActivity.
                    launch((Activity) context, livesBean.getRoom_id(),
                            ...
                            livesBean.getOwner().getName(), livesBean.getOwner().getMid(),livesBean.getPlayurl()));
            ...
            LiveBean.DataBean.PartitionsBean.PartitionBeanX partition = mLiveAppIndexInfo.
            ...
            liveBannerViewHolder.banner.setBannerStyle(BannerConfig.CIRCLE_INDICATOR)
                    .setDelayTime(2000).setImages(images).setImageLoader(new ImageLoader() {
                @Override
